...
export default function BodyHome() {
  ...
  return (
    <div name='bodyhome' className="px-5 md:px-12 pt-16 md:pt-5">
      <div className="flex flex-col md:flex-row justify-center items-center md:gap-x-16 px-8" data-aos="fade-up">
      ...
      <div className='flex flex-row justify-center pt-4 md:pt-0 md:gap-x-5 md:px-8'>
        <img src={FonRend2} alt='Font-rend4' className='h-10 md:h-28 absolute right-[0px] md:right-72 pr-3 md:pr-10'  data-aos="fade-up"/>
        <img src={Nasi} alt='Nasi' className='w-80 md:w-auto md:h-[500px]' data-aos="fade-up"/>
      </div>

      <div className='flex justify-center text-center px-2.5 pt-10 md:text-center md:whitespace-pre-wrap md:px-0 md:pt-0' data-aos="fade-up">
