  ...
  return (
    <div className="pb-5 px-14">
      ...
      <div className="flex flex-row justify-between items-center pb-8">
        <div className="flex flex-row space-x-10 md:space-x-32">
          {/* COMPONENT : 'ONE' */}
        ...
        <img src={Logo} alt="Logo" className="h-16 md:h-40 relative right-14 bottom-8"/>
      </div>

      {/* EXTRA CONTENT */}
      <div className="flex flex-row justify-end space-x-20 md:space-x-40">
